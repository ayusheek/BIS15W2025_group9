...
```
Within 2005-2014:
Success of movies starring all three were hitting a peak from 2013-2014
The masala movies from 2013 or 2014 were important successes in these actor's careers
...
```{r}
ggplot(genre_summary, aes(x = genre, y = count, fill = hit_flop.x)) +
...
```{r}
ggplot(actor_summary, aes(x = hit_flop.y, y = count, fill = lead_star)) +
