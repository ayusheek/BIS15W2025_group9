...
bollywood %>% 
  ...
  geom_boxplot()+
  scale_fill_brewer(palette="RdYlGn")+_
...
ranveer singh hasn't been in the industry as long as the other 2
...
2. What was the average revenue of movies in Old Bollywood vs New Bollywood?
```{r}
bollywood_eras %>%
  group_by(era) %>% 
  filter(era!="NA") %>% 
